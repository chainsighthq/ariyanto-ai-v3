...
class VolatilityAgent(BaseAgent):
    ...
    def act(self, reasoning: Dict[str, Any], task: Task) -> AgentResult:
        return AgentResult(task_id=task.task_id, agent_name=self.name, success=True, message=f"Volatility Forecast ({reasoning['symbol']}): Current IV 48%, 7d forecast 52%. Expected move: ±8.2%. Best strategy: Iron Condor or Short Strangle. Avoid directional bets.", simulation=self.simulation)
